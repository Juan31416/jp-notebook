...
- [Lisp First Steps](https://en.wikibooks.org/wiki/Common_Lisp/First_steps)
- [Awesom Common Lisp Learning](https://github.com/GustavBertram/awesome-common-lisp-learning)
